    ...
    return (
        <div className="landing">
            ...
            <p className="subtitle">
                ...
                -
                ( <a href="https://www.cantonfair.net/event/7420-automation-technology-expo-canada#booking" target="_blanc">
                    Show Map
                </a> )
                <br />
                Booth 1022 <br />
                <a href="https://www.admtoronto.com/en/show-brands/atx-canada.html" target="_blanc">
                    www.admtoronto.com
                </a>
